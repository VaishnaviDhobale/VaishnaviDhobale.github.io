          ...
          return (
            ...
            >
              ...
              <Img
                ...
                marginBottom="20px"
              />
              <Text className="project-title" fontWeight={"bold"} fontSize="30px" color="teal">
                {el.title}
              </Text>
              <Text className="project-description" m="20px 0px">{el.desc}</Text>
              <Box display={"flex"} justifyContent="center" mb="20px">
                {el.tech_stack.map((el) => {
                  return <Text className="project-tech-stack" p="0px 10px">{el}</Text>;
                })}
              </Box>
              <Box display={"flex"} justifyContent="space-around" mt="20px">
                <a className="project-deployed-link" href={el.deploy} target="_blank" style={achorStyle}>
                  View Live
                </a>
                <a className="project-github-link" target={"_blank"} href={el.gitHub} style={achorStyle}>
                  View Code
                </a>
              </Box>
            </Box>
